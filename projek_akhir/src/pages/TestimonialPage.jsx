      ...
      <div className="testimonial">
        <Container>
          <Row>
            ...
            <p className='text-center animate__animated animate__fadeInUp animate__delay-1s'>Lihat apa kata mereka yang sudah merasakan serunya belajar dan berkembang bersama Kursus Kelas!</p>
            </Col>
          </Row>
